...
describe('buildAppConnectionURL', () => {
  it('should build URL with all parameters', () => {
    ...
    expect(url.toString()).toBe(
      'https://192.168.1.210:14943/dashboard?canisterId=rrkah-fqaaa-aaaaa-aaaaq-cai',
    );
  });
  ...
  it('should build URL with minimal required parameters', () => {
    ...
    expect(url.toString()).toBe(
      'https://192.168.1.210:14943/?canisterId=rrkah-fqaaa-aaaaa-aaaaq-cai',
    );
  });
  ...
  it('should build URL with custom pathname', () => {
    const url = buildAppConnectionURL({
      dfxNetwork: 'local',
      localIPAddress: '192.168.1.210',
      targetCanisterId: 'rrkah-fqaaa-aaaaa-aaaaq-cai',
    ...
    expect(url.toString()).toBe(
      'https://192.168.1.210:14943/settings/profile?canisterId=rrkah-fqaaa-aaaaa-aaaaq-cai',
    );
  });
});
